UPDATE EVENT_4110 SET pmHoPrepAttLteInterFQci = (
 ...
 ) from EVENT_4110 A inner join topo_eucell B on A.CELL_ID = B.CELL_ID and A.ENB_ID = B.ENB_ID WHERE HOSOURCEORTARGETTYPE = 1;
UPDATE EVENT_4110 SET pmHoPrepAttLteIntraFQci = (
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 1 ) = 1  					AND HOPREPQCI != NULL   THEN 1 ELSE 0 END) +
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 2 ) /power(2,1) = 1  		AND HOPREPQCI_1 != NULL   THEN 1 ELSE 0 END) +
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 4 ) /power(2,2) = 1 		AND HOPREPQCI_2 != NULL   THEN 1 ELSE 0 END) +
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 8 ) /power(2,3) = 1 		AND HOPREPQCI_3 != NULL   THEN 1 ELSE 0 END) +
 ...
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 16384) /power(2,14) = 1 	AND HOPREPQCI_14 != NULL   THEN 1 ELSE 0 END) +
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 32768) /power(2,15) = 1 	AND HOPREPQCI_15 != NULL   THEN 1 ELSE 0 END) 
 ) from EVENT_4110 A inner join topo_eucell B on A.CELL_ID = B.CELL_ID and A.ENB_ID = B.ENB_ID
 WHERE HOSOURCEORTARGETTYPE = 0;
 UPDATE EVENT_4110 SET pmHoPrepOutAttQci = (
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 1 ) = 1  					AND HOPREPQCI != NULL        THEN 1 ELSE 0 END) +
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 2 ) /power(2,1) = 1  		AND HOPREPQCI_1 != NULL      THEN 1 ELSE 0 END) +
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 4 ) /power(2,2) = 1 		AND HOPREPQCI_2 != NULL      THEN 1 ELSE 0 END) +
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 8 ) /power(2,3) = 1 		AND HOPREPQCI_3 != NULL      THEN 1 ELSE 0 END) +
...
UPDATE EVENT_4110 SET pmHoPrepOutSuccQci = (
 ...
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 16384) /power(2,14) = 1 	AND (HOOUTPREPERABFAILBITMAP & 16384 ) /power(2,15) =0	 AND HOPREPQCI_14 !=NULL THEN 1 ELSE 0 END) +
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 32768) /power(2,15) = 1 	AND (HOOUTPREPERABFAILBITMAP & 32768 ) /power(2,16) =0	 AND HOPREPQCI_15 !=NULL THEN 1 ELSE 0 END) 
 ) from EVENT_4110 A inner join topo_eucell B on A.CELL_ID = B.CELL_ID and A.ENB_ID = B.ENB_ID ;
UPDATE EVENT_4110 SET pmHoPrepSuccLteInterFQci = (
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 1 ) = 1  					AND HOPREPQCI != NULL THEN 1 ELSE 0 END) +
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 2 ) /power(2,1) = 1  		AND HOPREPQCI_1 != NULL   THEN 1 ELSE 0 END) +
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 4 ) /power(2,2) = 1 		AND HOPREPQCI_2 != NULL   THEN 1 ELSE 0 END) +
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 8 ) /power(2,3) = 1 		AND HOPREPQCI_3 != NULL   THEN 1 ELSE 0 END) +
 ...
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 16384) /power(2,14) = 1 	AND HOPREPQCI_14 != NULL   THEN 1 ELSE 0 END) +
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 32768) /power(2,15) = 1 	AND HOPREPQCI_15 != NULL   THEN 1 ELSE 0 END) 
 ) from EVENT_4110 A inner join topo_eucell B on A.CELL_ID = B.CELL_ID and A.ENB_ID = B.ENB_ID WHERE PROCHOPREPOUTRESULT = 0 AND HOSOURCEORTARGETTYPE =1 ;
UPDATE EVENT_4110 SET pmHoPrepSuccLteIntraFQci = (
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 1 ) = 1  					AND HOPREPQCI != NULL    THEN 1 ELSE 0 END) +
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 2 ) /power(2,1) = 1  		AND HOPREPQCI_1 != NULL    THEN 1 ELSE 0 END) +
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 4 ) /power(2,2) = 1 		AND HOPREPQCI_2 != NULL    THEN 1 ELSE 0 END) +
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 8 ) /power(2,3) = 1 		AND HOPREPQCI_3 != NULL    THEN 1 ELSE 0 END) +
 ...
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 16384) /power(2,14) = 1 	AND HOPREPQCI_14 != NULL    THEN 1 ELSE 0 END) +
 (CASE WHEN (HOOUTPREPERABREQBITMAP & 32768) /power(2,15) = 1 	AND HOPREPQCI_15 != NULL    THEN 1 ELSE 0 END) 
 ) from EVENT_4110 A inner join topo_eucell B on A.CELL_ID = B.CELL_ID and A.ENB_ID = B.ENB_ID WHERE PROCHOPREPOUTRESULT = 0 AND HOSOURCEORTARGETTYPE = 0 ;
 Update EVENT_4110 set pmHoPrepOutFailTo=1 from EVENT_4110 A inner join topo_eucell B on A.CELL_ID = B.CELL_ID and A.ENB_ID = B.ENB_ID where PROCHOPREPOUTRESULT = 2 ;